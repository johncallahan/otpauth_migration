...
class GoogleAuthenticatorImport_OtpParameters extends $pb.GeneratedMessage {
  factory GoogleAuthenticatorImport_OtpParameters({
    ...
    final result = GoogleAuthenticatorImport_OtpParameters._();
  ...
  factory GoogleAuthenticatorImport_OtpParameters.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      GoogleAuthenticatorImport_OtpParameters()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance:
          GoogleAuthenticatorImport_OtpParameters.$_createMessage)
  ...
  @$core.Deprecated(
      'Use GoogleAuthenticatorImport_OtpParameters() / GoogleAuthenticatorImport_OtpParameters.new instead')
  static GoogleAuthenticatorImport_OtpParameters create() =>
      GoogleAuthenticatorImport_OtpParameters._();
  static $pb.GeneratedMessage $_createMessage() =>
      GoogleAuthenticatorImport_OtpParameters._();
  @$core.override
  GoogleAuthenticatorImport_OtpParameters createEmptyInstance() =>
      GoogleAuthenticatorImport_OtpParameters._();
  @$core.pragma('dart2js:noInline')
...
class GoogleAuthenticatorImport extends $pb.GeneratedMessage {
  factory GoogleAuthenticatorImport({
    ...
    final result = GoogleAuthenticatorImport._();
  ...
  factory GoogleAuthenticatorImport.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      GoogleAuthenticatorImport()..mergeFromBuffer(data, registry);
  factory GoogleAuthenticatorImport.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      GoogleAuthenticatorImport()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'GoogleAuthenticatorImport',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'KeePassOTP'),
      createEmptyInstance: GoogleAuthenticatorImport.$_createMessage)
    ..pPM<GoogleAuthenticatorImport_OtpParameters>(
        1, _omitFieldNames ? '' : 'otpParameters',
        subBuilder: GoogleAuthenticatorImport_OtpParameters.$_createMessage)
  ...
  @$core.pragma('dart2js:noInline')
  @$core.Deprecated(
      'Use GoogleAuthenticatorImport() / GoogleAuthenticatorImport.new instead')
  static GoogleAuthenticatorImport create() => GoogleAuthenticatorImport._();
  static $pb.GeneratedMessage $_createMessage() =>
      GoogleAuthenticatorImport._();
  @$core.override
  GoogleAuthenticatorImport createEmptyInstance() =>
      GoogleAuthenticatorImport._();
  @$core.pragma('dart2js:noInline')
  static GoogleAuthenticatorImport getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GoogleAuthenticatorImport>(
          GoogleAuthenticatorImport.$_createMessage);
