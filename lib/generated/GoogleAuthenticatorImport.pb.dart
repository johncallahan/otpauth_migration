...
class GoogleAuthenticatorImport_OtpParameters extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GoogleAuthenticatorImport.OtpParameters', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'KeePassOTP'), createEmptyInstance: create)
    ...
    ..e<GoogleAuthenticatorImport_Algorithm>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'algorithm', $pb.PbFieldType.OE, defaultOrMaker: GoogleAuthenticatorImport_Algorithm.ALGORITHM_UNSPECIFIED, valueOf: GoogleAuthenticatorImport_Algorithm.valueOf, enumValues: GoogleAuthenticatorImport_Algorithm.values)
    ..e<GoogleAuthenticatorImport_DigitCount>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'digits', $pb.PbFieldType.OE, defaultOrMaker: GoogleAuthenticatorImport_DigitCount.DIGIT_COUNT_UNSPECIFIED, valueOf: GoogleAuthenticatorImport_DigitCount.valueOf, enumValues: GoogleAuthenticatorImport_DigitCount.values)
    ..e<GoogleAuthenticatorImport_OtpType>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: GoogleAuthenticatorImport_OtpType.OTP_TYPE_UNSPECIFIED, valueOf: GoogleAuthenticatorImport_OtpType.valueOf, enumValues: GoogleAuthenticatorImport_OtpType.values)
  ...
  'Will be removed in next major version')
  GoogleAuthenticatorImport_OtpParameters copyWith(void Function(GoogleAuthenticatorImport_OtpParameters) updates) => super.copyWith((message) => updates(message as GoogleAuthenticatorImport_OtpParameters)) as GoogleAuthenticatorImport_OtpParameters; // ignore: deprecated_member_use
...
class GoogleAuthenticatorImport extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GoogleAuthenticatorImport', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'KeePassOTP'), createEmptyInstance: create)
    ..pc<GoogleAuthenticatorImport_OtpParameters>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'otpParameters', $pb.PbFieldType.PM, subBuilder: GoogleAuthenticatorImport_OtpParameters.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GoogleAuthenticatorImport copyWith(void Function(GoogleAuthenticatorImport) updates) => super.copyWith((message) => updates(message as GoogleAuthenticatorImport)) as GoogleAuthenticatorImport; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
