...
void main() {
  test('test parsing', () {
    ...
    expect(
      otpAuthParser.decode("otpauth-migration://offline?data=$string3"),
      list3,
    );

    expect(
      otpAuthParser.decode("otpauth-migration://offline?data=$string4"),
      list4,
    );

    expect(
      otpAuthParser.decode("otpauth-migration://offline?data=$string5"),
      list5,
    );
    ...
    expect(
      otpAuthParser.batchIndex("otpauth-migration://offline?data=$string1Of3"),
      0,
    );
    expect(
      otpAuthParser.decode("otpauth-migration://offline?data=$string1Of3"),
      list1Of3,
    );
    ...
    expect(
      otpAuthParser.batchIndex("otpauth-migration://offline?data=$string2Of3"),
      1,
    );
    expect(
      otpAuthParser.decode("otpauth-migration://offline?data=$string2Of3"),
      list2Of3,
    );
    ...
    expect(
      otpAuthParser.batchIndex("otpauth-migration://offline?data=$string3Of3"),
      2,
    );
    expect(
      otpAuthParser.decode("otpauth-migration://offline?data=$string3Of3"),
      list3Of3,
    );
